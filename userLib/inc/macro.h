...
#define	MisDevinfo(idx)  ((idx) == CINDEX_GETDEVINFO)    /** the index in table commandKeyArr **/
...
#define	MisReportSerice(idx)  ((idx) == CINDEX_REPORTSERVICE)   /** the index in table commandKeyArr **/
...
#define	MisHeartbeatCommand(idx)  ((idx) == CINDEX_HEARTBEAT)   /** the index in table commandKeyArr **/

#define	MisPutChar(idx)  ((idx) == CINDEX_PUTCHAR)    /** the index in table commandKeyArr **/

#define	MisGetChar(idx)  ((idx) == CINDEX_GETCHAR)    /** the index in table commandKeyArr **/
...
#define	MisScanWifi(idx)  ((idx) == CINDEX_SCANWIFI)       /** the index in table commandKeyArr **/
#define	MisScanWifiRespFail(idx, len, body) (MisScanWifi(idx) && (MisRespFail(len, body)))

#define	MisconnectWifi(idx)  ((idx) == CINDEX_CONNECTWIFI)       /** the index in table commandKeyArr **/
...
#define	MisputWifiStatus(idx)  ((idx) == CINDEX_PUTWIFISTATUS)    /** the index in table commandKeyArr **/
#define	MisgetWifiStatus(idx)  ((idx) == CINDEX_GETWIFISTATUS)    /** the index in table commandKeyArr **/
...
#define	MisResetNet(idx)  ((idx) == CINDEX_RESETNET)       /** the index in table commandKeyArr **/
...
#define	MisGetSsid(idx)  ((idx) == CINDEX_GETSSID)       /** the index in table commandKeyArr **/
#define	MisGetIp(idx)    ((idx) == CINDEX_GETIP)       /** the index in table commandKeyArr **/
#define	MisGetMac(idx)   ((idx) == CINDEX_GETMAC)       /** the index in table commandKeyArr **/

#define	MisGetRssi(idx)  ((idx) == CINDEX_GETRSSI)       /** the index in table commandKeyArr **/
#define	MisGetRssiFail(idx, len, body)   (MisGetRssi(idx) && (MisRespFail(len, body)))       /** the index in table commandKeyArr **/

#define	MisPutSync(idx)  ((idx) == CINDEX_PUTSYNC)       /** the index in table commandKeyArr **/
